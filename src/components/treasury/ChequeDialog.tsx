...
export function ChequeDialog({
  ...
  onSubmit: (value: ChequeFormValue) => void
}) {
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>
            Recibido: queda en cartera. Emitido: queda “a pagar” y se debita al
            marcarlo pagado.
          </DialogDescription>
        </DialogHeader>
        <ChequeForm
  ...
  return (
    <>
      ...
      <div className="grid gap-4">
        ...
        <div className="grid gap-2">
          <Label htmlFor="chq-librador">
            {tipo === 'recibido' ? 'Librador (quien lo emite)' : 'Beneficiario'}
          </Label>
          <Input
            id="chq-librador"
            placeholder={
        ...
        <div className="grid grid-cols-3 gap-4">
          <div className="grid gap-2">
            <Label htmlFor="chq-rec">
              {tipo === 'recibido' ? 'Recepción' : 'Emisión'}
            </Label>
            <Input
              id="chq-rec"
              type="date"
          ...
          <div className="grid gap-2">
            <Label htmlFor="chq-cobro">
              {tipo === 'recibido' ? 'Fecha de pago' : 'Vencimiento'}
            </Label>
            <Input
              id="chq-cobro"
              type="date"
        ...
        <div className="grid gap-2">
          ...
          <Input
            id="chq-notas"
            placeholder="Referencia, operación asociada…"
            value={notas}
