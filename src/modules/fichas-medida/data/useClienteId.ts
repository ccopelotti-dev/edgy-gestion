...
/**
 * Resuelve el cliente_id (tenant) del usuario logueado. Copia exacta del
 * hook del mismo nombre en Agenda/Configuración/Utilidades -- cada módulo
 * Supabase-backed mantiene su propia copia liviana, en vez de importar
 * entre módulos.
 */
