// ============================================================
// Modulo Home Keep — Dashboard
// Edgy Gestion · Vista general de gastos del hogar
// Clon recortado de compras/pages/Dashboard.tsx: sin KPI de "OC
// abiertas" (Home Keep no tiene Órdenes de Compra).
// ============================================================
...
export default function Dashboard() {
  ...
  return (
    <div className="space-y-6">
      <h1 className="text-2xl font-bold text-gray-900">Dashboard de Home Keep</h1>

      {/* KPIs */}
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
        <KpiCard
          title="Gastos del mes"
          value={formatARS(stats.gastosDelMes)}
                ...
                >
                  <div>
                    <p className="text-sm font-medium text-gray-900">
                      {formatNumero(PREFIJO_COMPROBANTE[c.tipo], c.numero)} — {nombreProveedor(c.proveedorId)}
                    </p>
