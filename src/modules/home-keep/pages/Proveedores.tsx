// ============================================================
// Modulo Home Keep — Proveedores
// Edgy Gestion · ABM y gestion de proveedores
// Clon de compras/pages/Proveedores.tsx adaptado a los tipos e imports
// propios de Home Keep -- "Nueva Orden de Pago" pasa a "Nuevo pago".
// ============================================================
...
import { ProveedorDialog, PagoDialog } from '../components/dialogs';
import {
...
import type { Proveedor, Pago } from '../types';
...
export default function Proveedores() {
  ...
  const handleDescargarComprobantePago = async (pago: Pago) => {
    if (!empresaActual) return;
    ...
    <div className="space-y-4">
      ...
      {proveedoresFiltrados.length === 0 ? (
        <EmptyState
          ...
          description="Cree un proveedor para comenzar a registrar gastos."
        />
      ) : (
                    ...
                    >
                      ...
                      <td className="px-4 py-3 whitespace-nowrap" onClick={(e) => e.stopPropagation()}>
                        <div className="flex items-center gap-1">
                          ...
                          <button onClick={() => handleRegistrarPago(prov.id)} className="p-1.5 text-gray-400 hover:text-gray-600 hover:bg-gray-100 rounded-lg" title="Nuevo pago">
                                ...
                                <div className="space-y-1">
                                  {pendientes.slice(0, 5).map((c) => (
                                    <div key={c.id} className="flex items-center justify-between rounded-lg bg-white px-3 py-2 text-sm border border-gray-100">
                                      <span className="font-mono text-xs">{formatNumeroComprobante(c.tipo, c.numero, c.numeroComprobanteProveedor)}</span>
