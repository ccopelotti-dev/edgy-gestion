 ...
 * mismo nombre en el módulo Configuración -- cada módulo Supabase-backed
 * mantiene su propia copia liviana (mismo criterio que lib/format.ts en
 * los módulos localStorage), en vez de importar entre módulos.
 */
