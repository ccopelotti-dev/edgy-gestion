// ============================================================
// Módulo Ventas — Integraciones
// Preparado para conectar con verticales y plataformas externas
// ============================================================

import { useState } from 'react';
import { useVentas } from '../data/store';
import { EmptyState } from '../components/ventas/display';
import {
...
export default function Integraciones() {
  const { config } = useVentas();
  const [filtroTipo, setFiltroTipo] = useState<string>('');
  const [selectedId, setSelectedId] = useState<string | null>(null);

  const integraciones = INTEGRACIONES.map(i =>
    i.id === 'afip' ? { ...i, activa: config.afipConfigurado } : i
  );
    ...
    <div className="space-y-6">
      ...
      <div>
        <p className="text-sm text-gray-500">
          Conectá el módulo de Ventas con subsistemas verticales, plataformas de e-commerce y servicios fiscales.
          ...
          {selected.id === 'afip' ? (
            <div className="space-y-4">
              ...
              <ol className="text-sm text-gray-600 space-y-1 list-decimal list-inside">
                ...
                <li>Punto de venta autorizado</li>
              </ol>
