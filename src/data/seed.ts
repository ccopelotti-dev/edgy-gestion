...
const bankAccounts: BankAccount[] = [
  {
    id: 'acc-galicia',
    banco: 'Banco Galicia',
    alias: 'distrib.norte.gali',
    numero: '4012-3 099-7',
    cbu: '0070099530004012309971',
    tipo: 'cuenta_corriente',
    moneda: 'ARS',
    saldoInicial: 1_850_000,
  },
  {
    id: 'acc-santander',
    banco: 'Santander',
    alias: 'distrib.norte.sant',
    numero: '201-005418/2',
    cbu: '0720201588000005418021',
    tipo: 'cuenta_corriente',
    moneda: 'ARS',
    saldoInicial: 940_000,
  },
  {
    id: 'acc-nacion',
    banco: 'Banco Nación',
    alias: 'distrib.norte.bna',
    numero: '0810-441002-3',
    cbu: '0110441030044100020035',
    tipo: 'caja_ahorro',
    moneda: 'ARS',
    saldoInicial: 425_000,
  },
  {
    id: 'acc-mp',
    banco: 'MercadoPago',
    alias: 'distribuidoranorte.mp',
    numero: 'CVU 000003100',
    cbu: '0000003100098765432109',
    tipo: 'caja_ahorro',
    moneda: 'ARS',
    saldoInicial: 312_500,
  },
]
